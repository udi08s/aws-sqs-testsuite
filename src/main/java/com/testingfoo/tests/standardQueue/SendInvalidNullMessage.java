...
public class SendInvalidNullMessage extends BaseTest {
	...
	@Description("Test to validate the Send Null Message feature")
	public void testSendInvalidNullMessageToTheQueue() {
		...
		Assert.assertTrue(recievedMessages.get(0).getBody().equals(sampleMessage),"Message is not available in the message Queue");
			...
			Assert.assertTrue(new Integer(ase.getStatusCode()).toString().equals("500"),"Incorrect error message is displayed");
		}
