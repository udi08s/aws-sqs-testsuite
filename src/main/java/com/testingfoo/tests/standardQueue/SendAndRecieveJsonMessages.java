...
public class SendAndRecieveJsonMessages extends BaseTest {
	...
	@Description("Test to validate the Send JSON message to the queue")
	public void testSendJSONMessagesToTheQueue() {
		
		sampleMessage=CommonUtils.readFile(System.getProperty("user.dir") + "//resources//testdata//test-jsonfile.json");
