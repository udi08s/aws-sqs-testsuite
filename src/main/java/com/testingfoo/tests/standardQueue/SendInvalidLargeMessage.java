...
public class SendInvalidLargeMessage extends BaseTest {
	...
	@Description("Test to validate the Send Different variety Message feature")
	public void testSendInvalidMessageToTheQueue() {
		
		sampleMessage=CommonUtils.readFile(System.getProperty("user.dir") + "//resources//testdata//largeSizeTestData.txt");
